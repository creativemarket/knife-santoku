module KnifeSantoku
  class Notifier    
    ...
    def initialize(config)
      ...
      @notifiers = { :hipchat => ::KnifeSantoku::Notification::HipchatNotifier, :campfire => ::KnifeSantoku::Notification::CampfireNotifier, :slack => ::KnifeSantoku::Notification::SlackNotifier }
